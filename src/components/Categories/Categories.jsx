  ...
  return (
    <div className="categories">
      <div className="col">
        <div className="row">
          <img
            src="https://images.pexels.com/photos/949671/pexels-photo-949671.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt=""
          />
          <button>
      ...
      <div className="col col-lg">
        <div className="row">
          ...
          <div className="col">
            <div className="row">
              <img
                src="https://images.pexels.com/photos/2853541/pexels-photo-2853541.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt=""
              />
              <button>
                <Link to="/products/1" className="link">
        ...
        <div className="row">
          <img
            src="https://images.pexels.com/photos/1462231/pexels-photo-1462231.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt=""
          />
          <button>
            <Link to="/products/1" className="link">
